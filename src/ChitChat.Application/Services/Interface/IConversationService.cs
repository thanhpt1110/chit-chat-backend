...
namespace ChitChat.Application.Services.Interface
{
    public interface IConversationService
    {
        ...
        Task<ConversationDto> UpdateConversation(ConversationDto conversation, string senderId);
        Task<ConversationDto> DeleteConversation(Guid conversationId, string senderId);
    }
}
