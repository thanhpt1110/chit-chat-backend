...
namespace ChitChat.DataAccess.Migrations
{
    ...
    [Migration("20241221022222_UpdaeFollower")]
    partial class UpdaeFollower
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChitChat.Domain.Entities.SystemEntities.Notification.CommentNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ChitChat.Domain.Entities.SystemEntities.Notification.PostNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ChitChat.Domain.Entities.SystemEntities.Notification.UserNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ChitChat.Domain.Entities.SystemEntities.Notification.CommentNotification", b =>
                {
                    ...
                    b.HasOne("ChitChat.Domain.Identity.UserApplication", "LastInteractorUser")
                        .WithMany()
                        .HasForeignKey("LastInteractorUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ChitChat.Domain.Identity.UserApplication", "ReceiverUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ChitChat.Domain.Entities.UserEntities.UserFollower", b =>
                {
                    b.HasOne("ChitChat.Domain.Identity.UserApplication", "Follower")
                        .WithMany()
